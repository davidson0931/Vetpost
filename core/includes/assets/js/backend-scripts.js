...
var productData, productTableData = [], productTableDataName = [], addedProducts = [], options = [],
    ...
    var d = new Date();
    var strDate = d.getFullYear() + "/" + (d.getMonth()+1) + "/" + d.getDate() + "/" + d.getTime();
...
(function( $ ) {
    ...
    $('#ProductID').click(function(){
        $("#loader-container-SOH").fadeIn();
    })

    $('#SendID').click(function(){
        $("#loader-container-Send").fadeIn();

    })
	
	$('#TrackOrderID').click(function(){
        $("#loader-container-Trackinfo").fadeIn();
